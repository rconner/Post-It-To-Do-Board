...
my_text1.configure(font = font_tuple, fg = 'cyan', bg = 'black')
text_1_button = Button(root, width=4, height=1, text = "Clear", command=delete_text1).grid(row=1, column=0, padx=2, pady=2)
my_text2 = Text(root, width=13, height=7, wrap="word")
my_text2.grid(row=0, column=1, padx=10, pady=10)
my_text2.configure(font = font_tuple, fg = 'yellow', bg = 'black')
text_2_button = Button(root, width=4, height=1, text = "Clear", command=delete_text2).grid(row=1, column=1, padx=2, pady=2)
my_text3 = Text(root, width=13, height=7, wrap="word")
my_text3.grid(row=0, column=2, padx=10, pady=10)
my_text3.configure(font = font_tuple, fg = 'magenta', bg = 'black')
...
my_text4.configure(font = font_tuple, fg = 'magenta', bg = 'black')
...
my_text5.configure(font = font_tuple, fg = 'cyan', bg = 'black')
...
my_text6.configure(font = font_tuple, fg = 'yellow', bg = 'black')
...
my_text7.configure(font = font_tuple, fg = 'yellow', bg = 'black')
...
my_text8.configure(font = font_tuple, fg = 'magenta', bg = 'black')
...
my_text9.configure(font = font_tuple, fg = 'cyan', bg = 'black')
...
my_text10.configure(font = font_tuple, fg = 'cyan', bg = 'black')
...
my_text11.configure(font = font_tuple, fg = 'yellow', bg = 'black')
...
my_text12.configure(font = font_tuple, fg = 'magenta', bg = 'black')
